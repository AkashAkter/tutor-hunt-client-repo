...
const Home = () => {
    ...
    return (
        <main>
            ...
            <section>
                <div class="grid lg:grid-cols-2 gap-4 m-12 lg:p-12 items-center	">
                    <div>
                        ...
                        <Link><button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Our Courses</button></Link>
                    </div>
                    <div>
            ...
            <section>
                ...
                <div class="grid grid-cols-4 text-center m-8">
            ...
            <section>
                <div class="lg:flex m-12 items-center">
                    <div class="w-2/5">
                ...
                <div className='enroll p-12'>
                    <div className='p-12 text-center'>
                        ...
                        <Link to='/courses'><button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Our Courses</button></Link>
                    </div>
                </div>
            </section>
